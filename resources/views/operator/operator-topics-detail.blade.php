                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-lg-5 col-12">
                            <div class="topics-detail-block bg-white shadow-lg">
                                <img src="../assets/img/topic-image/topics/undraw_Remote_design_team_re_urdx.png" class="topics-detail-block-image img-fluid">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8 col-12 m-auto">
                            ...
                            <div class="row my-4">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <img src="../assets/img/topic-image/businesswoman-using-tablet-analysis.jpg" class="topics-detail-block-image img-fluid">
                                </div>

                                <div class="col-lg-6 col-md-6 col-12 mt-4 mt-lg-0 mt-md-0">
                                    <img src="../assets/img/topic-image/colleagues-working-cozy-office-medium-shot.jpg" class="topics-detail-block-image img-fluid">
                                </div>
                            </div>
            ...
            <section class="section-padding section-bg">
                <div class="container">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-5 col-12">
                            <img src="../assets/img/topic-image/rear-view-young-college-student.jpg" class="newsletter-image img-fluid" alt="">
                        </div>
